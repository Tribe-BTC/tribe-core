...
- Alice and Bob put your Nostr Keys (Npub) into Bitpac.

- Alice create a multisig session with votes and treasurary.

- Bob can vote or reject

### Scenario with Ordinals 
